...
INSERT INTO `job_postings` (`job_id`, `job_title`, `job_description`, `location`, `salary`, `image_path`, `last_updated`) VALUES
	(22, 'Customer Service', 'Customer service representatives are responsible for addressing customer inquiries, resolving complaints, processing orders, and providing information about products and services.', 'US', '$45000', '/uploads/images.jpg', '2024-12-10 12:27:28'),
	(23, 'Computer Programmer', 'Computer programmers write, modify, and test code and scripts that allow computer software and applications to function properly.', 'Singapore', '$75000', '/uploads/images.jpg', '2024-12-10 12:27:15'),
	(24, 'Video Editor', 'In the video editor role, you will arrange, assemble, and process dozens of recorded and stock video clips into a seamless whole. You will work closely with the production and marketing teams to ensure alignment with project goals.', 'UK', '$10000', '/uploads/images.jpg', '2024-12-10 12:26:54'),
	(25, 'Software Developer', 'A Software Developer designs and builds computer programs that power mobile devices, desktop computers, and even cars.', 'China', '$50000', '/uploads/ss.png', '2024-12-10 12:27:04');
